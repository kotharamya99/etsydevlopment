...
function Signin({ setshowSignIn }) {
  ...
  const checkUser = (e) => {
    ...
    Axios.post("http://3.95.28.170:4000/signin", {
      email: email,
      password: password,
    })
      .then((response) => {
  ...
  useEffect(() => {
    Axios.get("http://3.95.28.170:4000/signin").then((response) => {
      // console.log(response);
        ...
        <div className="modal-content">
          ...
          <form className="signin_form">
            ...
            <div onClick={handleRegister}
              style={{ color: "grey" , width : "100%" , justifyContent : "center", placeContent:"center", display:"flex", marginTop:"15px", cursor:"pointer" }}>
